...
$sql="INSERT INTO `customer`(`PID`, `PNAME`, `BDATE`,`PROID`, `PRONAME`, `Price`, `INDATE`, `EXDATE`, `Interest`)
 VALUES ('$per_id','$name','$bdate','$proid','$proname','$price','$indate','$exdate','$interest')";
